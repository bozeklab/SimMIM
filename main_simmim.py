...
def main(config):
    ...
    for epoch in range(config.TRAIN.START_EPOCH, config.TRAIN.EPOCHS):
        ...
        train_one_epoch(config, model, data_loader_train, optimizer, epoch, loss_scaler, lr_scheduler)
...
def train_one_epoch(config, model, data_loader, optimizer, epoch, loss_scaler, lr_scheduler):
    model.train()
    optimizer.zero_grad()
    ...
    for data_iter_step, (img, mask, _) in enumerate(data_loader):
